...
def test_clear_winner_para():
    ...
    keyword = ClassificationResult(
        category="업무", confidence=0.65, source="keyword", tags=["업무", "회의"]
    )
...
def test_requires_user_review():
    ...
    para = ClassificationResult(category="Areas", confidence=0.73, source="para")

    keyword = ClassificationResult(
        category="학습", confidence=0.72, source="keyword", tags=["학습"]
    )
...
def test_keyword_wins():
    ...
    para = ClassificationResult(category="Resources", confidence=0.60, source="para")

    keyword = ClassificationResult(
        category="업무", confidence=0.88, source="keyword", tags=["업무", "프로젝트"]
    )
